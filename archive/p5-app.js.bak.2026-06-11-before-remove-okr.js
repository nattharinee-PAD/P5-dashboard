...
(function () {
  ...
  function renderDashboard() {
    ...
    <div class="page active" id="page-dashboard">
      ...
      <!-- ROW 3: ตารางรายงานวัดผลสถานการณ์ฝึกอบรม ณ ปัจจุบัน -->
      <div class="card">
        <div class="card-head">
          <div>
        ...
        <div class="tbl-wrap">
          <table class="tbl">
            ...
            <tbody id="reportTableBody">
              <tr><td colspan="7" style="text-align:center;padding:20px;color:#b8bcd6">กำลังโหลด...</td></tr>
            </tbody>
          </table>
        </div>
      </div>
      ...
      <div class="card">
        <div class="card-head">
          <div>
            <h3>🎯 OKR — ระบบพัฒนาบุคลากร</h3>
            <p>Objective + Key Results</p>
          </div>
          <div class="card-chip warn">PAD Team</div>
        </div>
        <div class="okr-grid">
          <div class="okr-row">
            <div class="okr-label">🎯 Objective</div>
            <div class="okr-text">สมาชิกมีแผนและได้รับการพัฒนาศักยภาพตามแผนครบทุกคน</div>
          </div>
          <div class="okr-row">
            <div class="okr-label okr-kr">KR 1</div>
            <div class="okr-text"><strong>ระบบอบรม</strong> · สมาชิกได้รับการฝึกอบรมตามแผน 100%</div>
            <div class="okr-pct ${trainingPct >= 80 ? 'green' : 'gold'}">${trainingPct}%</div>
          </div>
          <div class="okr-row">
            <div class="okr-label okr-kr">KR 2</div>
            <div class="okr-text"><strong>ระบบ Mentor</strong> · น้องเลี้ยงได้รับการดูแลแบบ 1:3 ครบ 100%</div>
            <div class="okr-pct ${m.pct >= 80 ? 'green' : 'gold'}">${m.pct}%</div>
          </div>
          <div class="okr-row">
            <div class="okr-label okr-kr">KR 3</div>
            <div class="okr-text"><strong>ระบบ Coach</strong> · สมาชิกที่ได้รับบทบาท Coach พัฒนาทักษะครบ</div>
            <div class="okr-pct ${c.pct >= 80 ? 'green' : 'gold'}">${c.pct}%</div>
          </div>
        </div>
      </div>
